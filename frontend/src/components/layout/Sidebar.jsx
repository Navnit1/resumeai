...
export default function Sidebar() {
  ...
  return (
    <aside className={`fixed top-0 left-0 h-full bg-dark-200 border-r border-dark-500 flex flex-col z-20 transition-all duration-300 ${sidebarOpen ? 'w-60' : 'w-16'}`}>
      {/* Logo */}
      ...
      <div className="p-3 border-t border-dark-500">
        <div className="flex items-center gap-2 p-2 rounded-lg hover:bg-dark-400 cursor-pointer transition-all" onClick={() => navigate('/profile')}>
